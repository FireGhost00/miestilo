    ...
    <table  width="90%" style="border: 1px " >
                 ...
                 <tr style="color: white; font-size: larger; " >
                     ...
                     echo "<td>".$registro['Categorias']."</td>";
                         ...
                         echo "<td>"."<a class='mantenimiento' href='EliminarProductos.php?codigo=".$registro['idProductos']."'> Eliminar</a>"."</td>";
                         echo "<td>"."<a class='mantenimiento' href='modificarProductos.php?codigo=".$registro['idProductos']."'>Modificar</a>"."</td>";
                     echo "</tr>";
                 }
