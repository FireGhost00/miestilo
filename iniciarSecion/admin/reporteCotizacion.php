...
$pdf->cell(25,8,'Nombres',1,0,'C',true);
...
$pdf->cell(17,8,'ID Producto',1,0,'C',true);
$pdf->cell(40,8,'Productos',1,0,'C',true);
...
while($fila2=$consulta->fetch_array())
{
  ...
  $pdf->cell(25,10,$fila2['Nombres'],0,0,'L');
  $pdf->cell(40,10,$fila2['Correo'],0,0,'L');
  $pdf->cell(20,10,$fila2['Telefono'],0,0,'L');
  $pdf->cell(15,10,$fila2['cantidad'],0,0,'L');
  $pdf->cell(20,10,$fila2['Categorias'],0,0,'L');
  $pdf->cell(17,10,$fila2['idProductos'],0,0,'L');
...
$pdf->ln($posiciony);
$pdf->Cell(100,10,'Total Cotizaciones: '.$consulta->num_rows,0,0,'R');
