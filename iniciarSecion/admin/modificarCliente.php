...
$sql="select * from clientes where tipo='cliente' and  id='$cod'";
...
<section id="caja_p">
    <form  action="actualizarcliente.php" method="POST">
        ...
        <table width="100%" >
            ...
            <tr>
                <td> Nombre:</td>
                <td> <input type="text" name="txtNombre" value="<?php echo $registro['nombres']; ?>" required></td>
            </tr>
            <tr>
                <td>Apellido:</td>
                <td> <input type="text" name="txtApe" value="<?php echo $registro['Apellidos']; ?>" required></td>
            </tr>
            <tr>
                <td> Sexo:</td>
                <td> <select name="txtsexo" required>
                        <option <?php if($registro['Sexo']=='M'){echo "selected";} ?>>Masculino</option>
                        <option <?php if($registro['Sexo']=='F'){echo "selected";}?>>Femenino</option>
                    </select></td>
            </tr>
       <tr>
           <td>Direccion:</td>
           <td><input type="text" name="txtDire" value="<?php echo $registro['direccion'];?>" required></td>
       </tr>
        <tr>
            <td>Telefono:</td>
            ...
            <tr>
                <td>password:</td>
               <td><input type="password" name="txtpass" placeholder="Ingrese SI desea cambiar o dejar vacio si NO"></td>
            </tr>
