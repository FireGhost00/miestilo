  ...
  <h2 style="font-size: 50px">Listado de Cotizaciones</h2>
    ...
    <table  width="90%" style="border: 1px " >
                 ...
                 <tr style="color: white; font-size: larger; " >
                     ...
                     {
                     echo "<tr>";
                     echo "<td>".$registro['idCotizacion']."</td>";
                     echo "<td>".$registro['Nombres']."</td>";
                     echo "<td>".$registro['Correo']."</td>";
                         echo "<td>".$registro['Telefono']."</td>";
                         echo "<td>".$registro['cantidad']."</td>";
                         echo "<td>".$registro['Categorias']."</td>";
                         echo "<td>".$registro['idProductos']."</td>";
                         echo "<td>".$registro['Nombre']."</td>";
                         echo "<td>"."<a class='mantenimiento' href='EliminarCotizacion.php?codigo=".$registro['idCotizacion']."'> Eliminar</a>"."</td>";
                         echo "<td>"."<a class='mantenimiento' href='modificarCotizacion.php?codigo=".$registro['idCotizacion']."'>Modificar</a>"."</td>";
                     echo "</tr>";
                 }
