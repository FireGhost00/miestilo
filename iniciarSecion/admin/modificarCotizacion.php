...
$sql="SELECT * FROM `cotizacion` WHERE  idCotizacion='$cod'";
...
<div id="modificar">
<section id="caja_p">
    <form name="frmCliente" action="actualizarCotizacion.php" method="POST">
        <table width="50%">
            <tr>
                <td>Codigo:</td>
                <td><?php echo $registro['idCotizacion']; ?></td>
            </tr>
            <tr>
                <td></td>
                <td> <input type="hidden" name="txtcodigo" value="<?php echo $registro['idCotizacion']; ?>" required></td>
            </tr>
            <tr>
                <td> Nombre:</td>
            ...
            <tr>
                <td>Cantidad:</td>
                <td><input type="text" name="txtCant" value="<?php echo $registro['cantidad'];?>" required></td>
            </tr>
            <tr>
                <td>
                    <input type="hidden" name="idprod" value="<?php echo $registro['idProducto']; ?>" >
                </td>
            </tr>
